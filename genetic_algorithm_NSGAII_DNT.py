...
best_fitness_value_page_load_time = []
...
while(gen_no < max_gen):
    ...
    function2_values = [population[i].fitness_page_load_time for i in range(0, pop_size)]
    ...
    if(gen_no == max_gen - 1):
        ...
        for valuez in non_dominated_sorted_solution[0]:
            ...
            print(population[valuez].fitness_page_load_time, end = " ")
            ...
            best_fitness_value_page_load_time.append(population[valuez].fitness_page_load_time)
    ...
    function2_values2 = [population2[i].fitness_page_load_time for i in range(0, pop_size * 2)]
